...
def format_source_blocks(chunks: list) -> str:
    """Nummerierte, delimitierte Quellen-Blöcke — EIN Format für Chat und Studio.

    Akzeptiert Chunk- oder ScoredChunk-Listen (ADR-005: [n] ↔ Chunk-Metadaten).
    """
    blocks = []
